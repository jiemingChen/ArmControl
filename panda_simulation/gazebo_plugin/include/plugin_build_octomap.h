...
class OctomapFromGazeboWorld : public WorldPlugin {
  ...
  */
  void CreateOctomap(const msg_pkg::Octomap::Request& msg);
 ...
 private:
  ...
  bool ServiceCallback(msg_pkg::Octomap::Request& req,
                      msg_pkg::Octomap::Response& res);
};
